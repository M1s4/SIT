...
where mac='ECE1A9ABFAA4'") or
                die("Problemas en el select:".mysqli_error($maysqli));
...
<input class="borrar_contacto" type="checkbox" name="<?php echo $reg['id_stockip']; ?>">
                          ...
                          <th>Tecnologia</th>
                          <th>Status</th>
                          <th><button type="button" name="Borrar" style="width:2px; height:2px;"id="btn_borrar" class="borrar">Borrar</button></th>
